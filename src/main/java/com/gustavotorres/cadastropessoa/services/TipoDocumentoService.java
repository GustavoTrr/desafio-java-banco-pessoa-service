...
public class TipoDocumentoService {
    ...
    public boolean isDocumentoValido(String numeroDocumento) {
        return (isCPFValido(numeroDocumento) || isCNPJValido(numeroDocumento));
    }

	public boolean isCPFValido(String numeroDocumento) {
		
		String cpf = removeCaracteresEspeciais(numeroDocumento);
	...
	public boolean isCNPJValido(String numeroDocumento) {
		
		String cnpj = removeCaracteresEspeciais(numeroDocumento);
